\title{41317 - CFD\\Sommer exam 2024}    % Insert title
\author{
...
\usepackage[hidelinks, pdfusetitle, pdfsubject={Computational Fluid Dynamics}, pdfkeywords={CFD, Exam}]{hyperref} %Subject and keywords
